  ...
  return (
    <div className="bg-[#1D5353] text-[#FFBBBB] w-100 h-auto text-sm rounded my-2 p-1 position-relative">
      ...
      <h6 className="m-0 p-0">
        Phone Number:{" "}
        <span className="text-[#A239EA] sm:text-lg">{booking.phNo}</span>
      </h6>
      <h6 className="m-0 p-0">
        You have to meet with{" "}
        <span className="text-[#A239EA] sm:text-lg">{booking.type}</span>.
      </h6>
      <h6 className="m-0 p-0">
        Date: <span className="text-[#A239EA] sm:text-lg">{booking.date}</span>
      </h6>
      <h6 className="m-0 p-0">
        Time:{" "}
        <span className="text-[#A239EA] sm:text-lg">
          {booking.time} ({booking.meridian})
        </span>
      </h6>
      <button
        onClick={cancelFun}
        className="bg-[#FFBBBB] text-[#BFFFF0] p-1 rounded position-absolute bottom-2 right-1"
      >
        cancel
      </button>
    </div>
